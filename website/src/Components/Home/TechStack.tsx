                    ...
                    <Grid item xs={6} sm={4} md={3} lg={3} xl={3} className={classes.gridItems}>
                        ...
                        <Box className={classes.techIcons}>
                            ...
                            <Box className={classes.svgIcon}>
                                ...
                                <Typography style={{color:'#222222', fontWeight: 600, marginTop:'5px'}} variant='h4'>TS</Typography>
                    ...
                    <Grid item xs={6} sm={4} md={3} lg={3} xl={3} className={classes.gridItems}>
                        ...
                        <Box className={classes.techIcons}>
                            ...
                            <Box className={classes.svgIcon}>
                                ...
                                <Typography style={{color:'#222222', fontWeight: 600, marginTop:'5px'}} variant='h4'>JS</Typography>
                        ...
                        <Box className={classes.techIcons}>
                            ...
                            <Box className={classes.svgIcon}>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="80%" height="90%"
                                    viewBox="0 0 172 172"
                                    style={{fill:'#000000', marginTop:'3px', marginLeft:'2px'}}>
                                    <g fill="none" 
                                        fill-rule="nonzero" 
                                        stroke="none" 
                                        stroke-width="1" 
